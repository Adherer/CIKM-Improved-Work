...
if __name__ == '__main__':
    ...
    torch_center_loss = torch_compute(negative_features, positive_features)
    ...
    with tf.Session() as sess:
        tensorflow_center_loss, fm_mask = sess.run(tensorflow_compute(negative_features, positive_features))

    print("torch_center_loss_" + str(torch_center_loss))
    print("tensorflow_center_loss_" + str(tensorflow_center_loss))
    print("fm_mask_" + str(fm_mask))
